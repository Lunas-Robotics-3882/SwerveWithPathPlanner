...
public class IndexerSubsystem extends SubsystemBase {
  ...
  m_index.getConfigurator().apply(configs);
  m_index.setNeutralMode(NeutralModeValue.Coast);
  }
...
//  COMMANDS  //
  ...
  public void disable()
  {
    m_index.setControl(m_brake);
  }

  public void setVelocity(double desiredRotationsPerSecond)
{
    m_index.setControl(m_velocityVoltage.withVelocity(desiredRotationsPerSecond));
}
...
SmartDashboard.putNumber("Index Encoder", m_index.getPosition().getValueAsDouble());
SmartDashboard.putNumber("Index Velocity", m_index.getVelocity().getValueAsDouble());
  }
}
